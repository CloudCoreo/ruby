...
module Kubernetes
  class AppsV1beta1Api
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @return [Array<(AppsV1beta1DeploymentRollback, Fixnum, Hash)>] AppsV1beta1DeploymentRollback data, response status code and response headers
    def create_namespaced_deployment_rollback_with_http_info(name, namespace, body, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'AppsV1beta1DeploymentRollback')
      if @api_client.config.debugging
    ...
    # @return [V1Status]
    def delete_namespaced_controller_revision(name, namespace, body, opts = {})
      data, _status_code, _headers = delete_namespaced_controller_revision_with_http_info(name, namespace, body, opts)
      return data
    end
    ...
    # @option opts [String] :propagation_policy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy.
    # @return [Array<(V1Status, Fixnum, Hash)>] V1Status data, response status code and response headers
    def delete_namespaced_controller_revision_with_http_info(name, namespace, body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AppsV1beta1Api.delete_namespaced_controller_revision"
      end
      # resource path
    ...
    # @option opts [String] :propagation_policy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy.
    # @return [V1Status]
    def delete_namespaced_deployment(name, namespace, body, opts = {})
      data, _status_code, _headers = delete_namespaced_deployment_with_http_info(name, namespace, body, opts)
      return data
    end
    ...
    # @option opts [String] :propagation_policy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy.
    # @return [Array<(V1Status, Fixnum, Hash)>] V1Status data, response status code and response headers
    def delete_namespaced_deployment_with_http_info(name, namespace, body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AppsV1beta1Api.delete_namespaced_deployment"
      end
      # resource path
    ...
    # @option opts [String] :propagation_policy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy.
    # @return [V1Status]
    def delete_namespaced_stateful_set(name, namespace, body, opts = {})
      data, _status_code, _headers = delete_namespaced_stateful_set_with_http_info(name, namespace, body, opts)
      return data
    end
    ...
    # @option opts [String] :propagation_policy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy.
    # @return [Array<(V1Status, Fixnum, Hash)>] V1Status data, response status code and response headers
    def delete_namespaced_stateful_set_with_http_info(name, namespace, body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AppsV1beta1Api.delete_namespaced_stateful_set"
      end
      # resource path
